<template>
    ...
    <ul class="inbox-nav inbox-divider">
      <li :class='{active:activeView =="appInbox"}'>
          <a href="#" @click='changeView("appInbox","title ")'><i class="fa fa-inbox"></i> Inbox <span class="label label-danger pull-right">2</span></a>

      </li>
      <li :class='{active:activeView =="appSent"}'>
          <a href="#" @click='changeView("appSent","title ")'><i class="fa fa-envelope-o"></i> Sent Mail</a>
      </li>
      <li :class='{active:activeView =="appImportant"}'>
          <a href="#" @click='changeView("appImportant","title ")'><i class="fa fa-bookmark-o"></i> Important</a>
      </li>
      <li :class='{active:activeView =="appViewmessage"}'>
          <a href="#" @click='changeView("appViewmessage","title ")'><i class=" fa fa-external-link"></i> Drafts <span class="label label-info pull-right">30</span></a>
      </li>
      <li :class='{active:activeView =="appTrash"}'>
          <a href="#" @click='changeView("appTrash","title ")'><i class=" fa fa-trash-o"></i> Trash</a>
      </li>
  </ul>
  <ul class="nav nav-pills nav-stacked labels-info inbox-divider hidden">
      <li> <h4>Labels</h4> </li>
  ...
  <ul class="nav nav-pills nav-stacked labels-info hidden">
  ...
  <div class="inbox-body text-center hidden">
      <div class="btn-group">
...
export default{
	...
	methods:{
		changeView: function(tagview,titleview){
			eventBus.$emit('eventchangeView',{
				tag: tagview,
				title:titleview
			})
		}
