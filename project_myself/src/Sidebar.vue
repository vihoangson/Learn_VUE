	...
	<aside class="sm-side">
		...
		<ul class="inbox-nav inbox-divider">
			<li :class='{active:activeView == "appInbox"}'>
				<a @click.prevent='changeView("appInbox","title ")' href="#"><i class="fa fa-inbox"></i> Inbox <span class="label label-danger pull-right">2</span></a>

			</li>
			<li :class='{active:activeView == "appSent"}'>
				<a @click.prevent='changeView("appSent","title ")' href="#"><i class="fa fa-envelope-o"></i> Sent Mail</a>
			</li>
			<li :class='{active:activeView == "appImportant"}'>
				<a @click.prevent='changeView("appImportant","title ")' href="#"><i class="fa fa-bookmark-o"></i> Important</a>
			</li>
			<li :class='{active:activeView == "appViewMessage"}'>
				<a @click.prevent='changeView("appViewMessage","title ")' href="#"><i class=" fa fa-external-link"></i> Drafts <span class="label label-info pull-right">30</span></a>
			</li>
			<li :class='{active:activeView == "appTrash"}'>
				<a @click.prevent='changeView("appTrash","title ")' href="#"><i class=" fa fa-trash-o"></i> Trash</a>
			</li>
		</ul>
